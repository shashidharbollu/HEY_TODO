...
module.exports.toogleStatus = async function(req, res){
    ...
    try{
        ...
        console.log("Error in toggling Status of the TODO, " + err);
        return res.redirect('/');
    }
...
module.exports.toggleFavourite = async function(req, res){
   ...
   let message;
    try{
        ...
        if(favourite == true){
            message = "TODO removed from favourites"
            favourite = false;
        }else{
            message = "TODO added to favourites"
            favourite = true;
        }
        req.flash('success', message);
...
module.exports.removeHabit = async (req, res) => {
    try {
        ...
        req.flash('success', 'Deleted TODO successfully!');
